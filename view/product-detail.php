<?php
    ...
    if(product_detail_image($id)==false){$product_detail_image=array('Anh1'=>$product['AnhNen'],'Anh2'=>$product['AnhNen'],'Anh3'=>$product['AnhNen'],'Anh4'=>$product['AnhNen']); }else{ $product_detail_image=mysqli_fetch_array(product_detail_image($id));}
?>
                    ...
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh1'] ?>" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh2'] ?>" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh3'] ?>" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh4'] ?>" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
                </div>
