						...
						<div class="col-sm-8 offset-sm-2 text-center">
							<div class="row">
								<div class="owl-carousel2">
									<div class="item">
										<div class="col">
											<h3><a href="#">Giảm giá 25% (Hầu hết) Mọi thứ! Sử dụng mã: Giảm giá mùa Giáng Sinh</a></h3>
										</div>
									</div>
									<div class="item">
										<div class="col">
											<h3><a href="#">Giảm giá lớn nhất của chúng tôi. giảm 50% cho tất cả giày mùa đông</a></h3>
										</div>
									</div>
								</div>
							</div>
